#!/bin/bash
# Quick tile size sweep - tests key tile sizes only
# For full sweep, use benchmark_tile_sweep.sh
...
RESULTS_FILE="${RESULTS_DIR}/quick_sweep_${TIMESTAMP}.csv"
...
# Quick sweep: test key tile sizes only (not all combinations)
# These represent different strategies:
# - 32: Aggressive L1 fit
# - 48: Moderate cache usage
# - 64: Balanced (current default for many cases)
# - 96: Larger tiles for more reuse
# - 128: Maximum reuse, minimize overhead
...
echo "=================================="
echo "IQ4_NL GEMM Quick Tile Sweep"
echo "=================================="
