...
**Supersedes**: `docs/v2/HANDOVER_CUDA_TENSORCORE_GEMM_TUNING.md` where it claims the custom prefill file is not the active direction. That is no longer true in the current workspace state.
