...
1. **Review design documents**:
   - `docs/v2/SNAPSHOT_FRAMEWORK_DESIGN.md` (full spec)
   - `docs/v2/SNAPSHOT_QUICK_START.md` (usage guide)
   - `docs/v2/SNAPSHOT_ARCHITECTURE.md` (diagrams)
   - `docs/v2/SNAPSHOT_IMPLEMENTATION_ROADMAP.md` (this file)
