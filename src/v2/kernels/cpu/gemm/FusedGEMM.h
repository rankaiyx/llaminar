 ...
 * 3. All GEMMs output FP32 (via CPUQuantisedGemmKernel) OR Q8_1 (via fused epilogue)
 *
 * Use Cases:
...
#include "CPUQuantisedGemmKernel.h"
#include <cstdint>
#include <vector>
#include <memory>
#include <string>
...
namespace llaminar2
{
     ...
     *
     * Wraps N CPUQuantisedGemmKernel instances, quantizes activations once,
