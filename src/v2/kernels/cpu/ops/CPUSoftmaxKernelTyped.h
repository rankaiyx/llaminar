/**
 * @file CPUSoftmaxKernelTyped.h
 * @brief Typed Softmax kernel with ActivationPrecision support
 * @author David Sanftenberg
 *
 * This kernel follows the "kernel black-box model" pattern from CPURoPEKernelTyped:
...
namespace llaminar2
{
    ...
    // =========================================================================
    // Precision Metadata Traits (same pattern as CPURoPEKernelTyped)
    // =========================================================================
    ...
    template <>
    class CPUSoftmaxKernelTyped<ActivationPrecision::FP32> : public CPUKernelBase
    {
    public:
        using StorageType = float;

        CPUSoftmaxKernelTyped() = default;
        ~CPUSoftmaxKernelTyped() override;
    ...
    template <>
    class CPUSoftmaxKernelTyped<ActivationPrecision::BF16> : public CPUKernelBase
    {
    public:
        using StorageType = uint16_t;
    ...
    template <>
    class CPUSoftmaxKernelTyped<ActivationPrecision::FP16> : public CPUKernelBase
    {
    public:
        using StorageType = uint16_t;
     ...
     */
    template <>
    class CPUSoftmaxKernelTyped<ActivationPrecision::Q8_1> : public CPUKernelBase
    {
    public:
        using StorageType = Q8_1Block;
